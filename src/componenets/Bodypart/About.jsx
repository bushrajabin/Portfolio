    ...
    return (
        <div className='  xl:flex xl:flex-row xl:cursor-pointer '>
            <div className='xl:max-w-4xl  xl:p-10'>
                <h1 className=' text-center underline font-serif text-xl pt-6 xl:text-4xl xl:font-serif xl:text-center xl:underline xl:tracking-wider'>Welcome to <span className=' text-purple-800'>CodeWithBushra</span></h1>
